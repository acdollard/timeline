  ...
  return (
    <>
      ...
      >
        ...
        {showTooltip && (
          <div 
            className={`${tooltipClasses} ${(!isMobile && index !== 0 && index % 2 === 0) ? "rotate-180 origin-bottom -translate-y-full" : "overflow-contain"}`}
        ...
        {!isBirth && (
          <div className={`shaft shaft-${event.id} ${
            !isMobile 
              ...
              : 'translate-x-8 w-8 h-0.5 bg-white top-1/2'
          }`} />
        )}
      </div>
    </>
